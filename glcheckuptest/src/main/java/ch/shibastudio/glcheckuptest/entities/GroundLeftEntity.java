...
public class GroundLeftEntity extends AbstractBodyEntity {
	...
	public GroundLeftEntity(float x, float y, float w, float h){
		this(x, y, w, h, new float[]{0.607f, 0.607f, 0.607f, 1.0f});
	}

	public GroundLeftEntity(float x, float y, float w, float h, float[] color){
		super(color);
		...
		super.drawOrder = new short[]{0, 1, 4, 4, 1, 3, 1, 2, 3};
