...
/**
 * A layer on top of ShaderProgramOld to store specific parameters to be reused.
 * It stores render states and textures that we will set in conjunction with
 * a specific ShaderProgramOld -- allowing the ShaderProgramOld to be reused with
...
public class Material {
	...
	/// Member variables
	protected ShaderProgramOld mShader = null;
	...
	public void beginRender() {
		...
		// enable all textures
		int textureIdx = 0;
		for (Map.Entry<String, Texture> texture : mTextures.entrySet()) {
	...
	/**
	 * Provide access to the ShaderProgramOld function
	 */
